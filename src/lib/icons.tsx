...
interface IconProps {
  name: IconName | 'phone' | 'mail' | 'mappin' | 'clock' | 'menu' | 'close' | 'chevron' | 'arrow' | 'quote' | 'check' | 'globe'
  size?: number
  className?: string
  strokeWidth?: number
}
    ...
    case 'handshake':
      return (
        <svg {...props}>
          ...
          <path d="M12 5.36 8.87 8.5a2.13 2.13 0 0 0 0 3l2.13 2.12" strokeWidth="1.2" />
